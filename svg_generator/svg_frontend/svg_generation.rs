...
pub fn render_svg(
    ...
    let code_image_file_path = format!("{}vis_code.svg here", output_path);
    ...
    (utils::read_lines(input_path.to_owned() + "annotated_source.rs"), utils::read_lines(input_path.to_owned() + "source.rs")) {
